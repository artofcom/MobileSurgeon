...
namespace TS.PageSlider
{
    public class PageScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler
    {
        ...
        //private
        public void ScrollToPage(int page, float moveSpeed=.0f)
        {
            _targetNormalizedPosition = page * (1f / GetPageCount());
            _moveSpeed = moveSpeed>.0f ? moveSpeed : (_targetNormalizedPosition - _scrollRect.horizontalNormalizedPosition) / _snapDuration;
