...
//#if UNITY_ANDROID && !UNITY_EDITOR
        [SerializeField] float TopOffset = 0.0f;// Y offset from Top due to the Status Bar.
//#endif
        ...
        void ApplySafeArea (Rect r)
        {
...
#if UNITY_ANDROID && !UNITY_EDITOR
                Vector2 anchorMax = r.position + new Vector2(r.size.x, r.size.y-TopOffset);
#else
            ...
            Core.Events.EventSystem.DispatchEvent("OnNewSafeAreaApplied", (object)Panel);
        }
    }
}
